package src.main.java.solid.bad.d;
...
public class PaymentManager {
    ...
    public PaymentManager() {
        this.creditCardProcessor = new CreditCardProcessor(); // Direct dependency on a concrete implementation
        this.paypalProcessor = new PaypalProcessor(); // Direct dependency on a concrete implementation
    }

    public void processCreditCardPayment(double amount) {
        creditCardProcessor.processPayment(amount); // Directly using the CreditCardProcessor's method
    }

    public void processPaypalPayment(double amount) {
        paypalProcessor.processPayment(amount); // Directly using the PaypalProcessor's method
    }
